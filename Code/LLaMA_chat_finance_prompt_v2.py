...
prompt = "You are an expert in finance specialised in stock trading. Extract tickers of public companies mentioned in the following headline: "

with open("outputs_llama_finance_prompt_v2.txt", "w", encoding="utf-8") as f:
